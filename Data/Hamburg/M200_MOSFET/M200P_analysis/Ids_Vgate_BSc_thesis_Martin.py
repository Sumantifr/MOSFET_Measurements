...
FILE1 = "M200P_04_HPKTS_1_MOSFET_2016-10-28_2.iv"
FILE2 = "M200P_04_HPKTS_1_MOSFET_2016-10-31_3.iv"
FILE3 = "M200P_04_HPKTS_1_MOSFET_2016-10-31_4.iv"
FILE4 = "M200P_04_HPKTS_1_MOSFET_2016-11-01_5.iv"
FILE5 = "M200P_04_HPKTS_1_MOSFET_2016-11-01_6.iv"
FILE6 = "M200P_04_HPKTS_1_MOSFET_2016-11-01_7.iv"
FILE7 = "M200P_04_HPKTS_1_MOSFET_2016-11-01_8.iv"
...
print "The chi_square - Vback= -1.0 V is:", Chi_sq(Cur_3,Id_plot(Vr_3,Alpha_3,beta_3,V_th_3),w_3), "."         
...
figure(1)
PLOT_IV = plot(Vol1, Curr1*1e6, "o-", label = "$V_{back}$ = 0 V",  markersize = 5, color='b', linewidth = 2.0)
PLOT_IV = plot(Vol2, Curr2*1e6, "^-", label = "$V_{back}$ = -0.5 V",  markersize = 5, color='r', linewidth = 2.0)
PLOT_IV = plot(Vol3, Curr3*1e6, "s-", label = "$V_{back}$ = -1.0 V",  markersize = 5, color='c', linewidth = 2.0)
...
PLOT_IV = plot(Vol6, Curr6*1e6, "p-", label = "$V_{back}$ = -5.0 V",  markersize = 5, color='black', linewidth = 2.0)
