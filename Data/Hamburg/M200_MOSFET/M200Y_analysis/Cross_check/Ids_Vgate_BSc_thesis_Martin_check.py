...
FILE1 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_67.iv"
FILE2 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_68.iv"
FILE3 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_69.iv"
FILE4 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_70.iv"
FILE5 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_71.iv"
FILE6 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_72.iv"
FILE7 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_73.iv"
FILE8 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_74.iv"
FILE9 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_75.iv"
FILE10 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_76.iv"
FILE11 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_77.iv"
FILE12 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_78.iv"
FILE13 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_79.iv"
FILE14 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_80.iv"
FILE15 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_81.iv"
FILE16 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_82.iv"
FILE17 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_83.iv"
FILE18 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_84.iv"
FILE19 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_85.iv"
FILE20 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_86.iv"
FILE21 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_87.iv"
FILE22 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_88.iv"
FILE23 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_89.iv"
FILE24 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_90.iv"
FILE25 = "M200Y_06_HPKTS_2_MOSFET_2017-02-24_91.iv"
...
PLOT_IV = plot(Vol2, Curr2*1e6, "-", label = "$V_{back}$ = -5 V",  markersize = 5, color='r', linewidth = 2.0)
PLOT_IV = plot(Vol3, Curr3*1e6, "-", label = "$V_{back}$ = -10 V",  markersize = 5, color='c', linewidth = 2.0)
PLOT_IV = plot(Vol4, Curr4*1e6, "-", label = "$V_{back}$ = -15 V",  markersize = 5, color='g', linewidth = 2.0)
PLOT_IV = plot(Vol5, Curr5*1e6, "-", label = "$V_{back}$ = -20 V",  markersize = 5, color='m', linewidth = 2.0)
PLOT_IV = plot(Vol6, Curr6*1e6, "-", label = "$V_{back}$ = -25 V",  markersize = 5, color='black', linewidth = 2.0)
PLOT_IV = plot(Vol7, Curr7*1e6, "-", label = "$V_{back}$ = -30 V",  markersize = 5, color='y', linewidth = 2.0)
PLOT_IV = plot(Vol8, Curr8*1e6, "-", label = "$V_{back}$ = -35 V",  markersize = 5, color='brown', linewidth = 2.0)
PLOT_IV = plot(Vol9, Curr9*1e6, "-", label = "$V_{back}$ = -40 V",  markersize = 5, color='gray', linewidth = 2.0)
PLOT_IV = plot(Vol10, Curr10*1e6, "-", label = "$V_{back}$ = -45 V",  markersize = 5, color='olive', linewidth = 2.0)
PLOT_IV = plot(Vol11, Curr11*1e6, "--", label = "$V_{back}$ = -50 V",  markersize = 5, color='b', linewidth = 2.0)
PLOT_IV = plot(Vol12, Curr12*1e6, "--", label = "$V_{back}$ = -55 V",  markersize = 5, color='r', linewidth = 2.0)
PLOT_IV = plot(Vol13, Curr13*1e6, "--", label = "$V_{back}$ = -65 V",  markersize = 5, color='g', linewidth = 2.0)
...
PLOT_IV = plot(Vol17, Curr17*1e6, "--", label = "$V_{back}$ = -85 V",  markersize = 5, color='brown', linewidth = 2.0)
...
ylabel("I$_{ds}$ [uA]", fontsize = 18, fontproperties = fp, fontweight='bold')
grid(True)
#yscale("log")
